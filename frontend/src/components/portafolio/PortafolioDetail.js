                ...
                <div className='bg-zinc-100 dark:bg-gray-900'>
                  ...
                  <article className="px-4 py-24 mx-auto max-w-7xl" itemid="#" itemscope itemtype="http://schema.org/BlogPosting">
                    <div className="w-full mx-auto mb-12 text-left md:w-3/4 lg:w-1/2">
                      ...
                      <p className="mt-6 mb-2 text-xs font-semibold tracking-wider uppercase text-primary text-blue-700 dark:text-blue-300">Development</p>
                      <h1 className="mb-3 text-3xl font-bold leading-tight text-blue-900 dark:text-blue-100 md:text-4xl" itemprop="headline" title="Rise of Tailwind - A Utility First CSS Framework">
                        {project.title}
                      </h1>
                      ...
                      <div className="-mt-3 flex items-center text-gray-700 dark:text-blue-200">
                      Creado en: 
                        {project.created_at && (
                          <p className="ml-2 text-sm font-semibold text-gray-800 dark:text-blue-200">
                      ...
                      <div className="mt-4">
                          <p className="text-sm font-semibold text-gray-800 dark:text-blue-200">Tecnologías utilizadas
                          </p>
