...
const HeroSection = () => {
    ...
    return(
        ...
        <section className="bg-zinc-100 dark:bg-gray-900 py-12 lg:py-16">
            <div className="max-w-screen-xl px-4 mx-auto lg:grid lg:grid-cols-12 lg:gap-8 lg:pt-4">
                ...
                <div className="lg:col-span-5 lg:flex lg:justify-end pt-12 ml-24">
                    <img src={foto_hero} className="rounded-full border-2 dark:border-white border-blue-900 h-64 w-64 lg:h-96 lg:w-96" alt="hero" />
                </div>                
            </div>
        </section>
