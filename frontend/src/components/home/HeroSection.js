        ...
        <section className="bg-zinc-100 dark:bg-gray-900 py-12 lg:py-16 mt-20 md:mt-24 lg:pb-24 pb-28">
            <div className="max-w-screen-xl mx-auto lg:grid lg:grid-cols-12 lg:gap-8 lg:pt-4">
                <div className="lg:col-span-7 lg:flex lg:flex-col lg:justify-center">
                    ...
                    <p className="mb-6 text-gray-500 lg:mb-8 md:text-lg lg:text-xl px-7 md:pl-10 dark:text-gray-400">Soy un apasionado desarrollador especializado en la creación de sitios y aplicaciones web. Mi enfoque se centra en combinar la potencia de <a href="https://www.djangoproject.com/" target="_blank" rel="noreferrer" className="hover:underline">Django</a> para el backend y la versatilidad de <a href="https://es.react.dev/" target="_blank" rel="noreferrer" className="hover:underline">React</a> para el frontend, brindando soluciones web robustas, eficientes y visualmente atractivas.</p>
